...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Mon Mar 22 11:51:28 2021
#
...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.SetSize((605, 419))
        self.SetTitle("KNetScanner")

        self.panel_main = wx.Panel(self, wx.ID_ANY)

        sizer_main = wx.FlexGridSizer(1, 2, 0, 0)

        sizer_main_left = wx.FlexGridSizer(2, 1, 0, 0)
        ...
        sizer_7 = wx.FlexGridSizer(1, 4, 0, 0)
        sizer_6.Add(sizer_7, 1, wx.EXPAND, 0)

        self.text_host = wx.TextCtrl(self.panel_main, wx.ID_ANY, "")
        sizer_7.Add(self.text_host, 0, wx.EXPAND, 0)

        self.text_port = wx.TextCtrl(self.panel_main, wx.ID_ANY, "")
        sizer_7.Add(self.text_port, 0, wx.EXPAND, 0)

        self.text_name = wx.TextCtrl(self.panel_main, wx.ID_ANY, "")
        sizer_7.Add(self.text_name, 0, wx.EXPAND, 0)

        self.button_add = wx.Button(self.panel_main, wx.ID_ANY, "Add target")
        sizer_7.Add(self.button_add, 0, wx.EXPAND, 0)

        sizer_8 = wx.FlexGridSizer(1, 4, 0, 0)
        sizer_6.Add(sizer_8, 1, wx.EXPAND, 0)

        label_3 = wx.StaticText(self.panel_main, wx.ID_ANY, "Threads")
        sizer_8.Add(label_3, 0, wx.ALL | wx.EXPAND, 0)

        self.spin_ctrl_threads = wx.SpinCtrl(self.panel_main, wx.ID_ANY, "8", min=1, max=1000)
